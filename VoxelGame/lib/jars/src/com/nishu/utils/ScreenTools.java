...
public class ScreenTools {
	...
	public static void clearScreen(boolean clearDepth, float r, float g, float b, float a){
	...
	public static void clearScreenBits(boolean clearDepth){
		...
		else if(!clearDepth) glClear(GL_COLOR_BUFFER_BIT);
	}
	...
	public static void renderOrtho(double left, double right, double bottom, double top){
	...
	public static void render3D() {
		...
		gluPerspective(67.0f, Display.getWidth() / Display.getHeight(), 0.001f, 1000f);
		glMatrixMode(GL_MODELVIEW);
